...
public class MyControllerIntegrationTests {
        ...
        private static List<Product> createProducts() {
			...
			products.add(new Product(null, 15, 30, ProductType.FLASHSALE, "Moulinex Pro", null, null,
					null,LocalDate.now().plusDays(1),1,2));
			products.add(new Product(null, 15, 30, ProductType.FLASHSALE, "SmartTv", null, null,
